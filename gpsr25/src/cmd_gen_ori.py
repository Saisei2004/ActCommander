...
#         person_cmd_list = ["meetPrsAtBeac"]
        
#         # Object manipulation and perception commands
#         object_cmd_list = ["tellCatPropOnPlcmt"]#, "takeObjFromPlcmt", "findObjInRoom", "countObjOnPlcmt", "tellObjPropOnPlcmt",
...
# location_names = ["kitchen", "living room", "bedroom", "office"]
# placement_location_names = ["table", "shelf", "tall table"]
# room_names = ["kitchen", "living room", "bedroom", "office"]
# object_names = ["bottle", "cup", "box"]
# object_categories_plural = ["bottles", "cups", "boxes"]
# object_categories_singular = ["bottle", "cup", "box"]
...
# # コマンド生成・出力
# for i in range(10):
#     command = cmd_gen.generate_command_start()
#     print(command)